...
check("version_metadata", "// @version      1.17.80" in s)
check("version_build", "const BUILD_VERSION = '1.17.80';" in s)
for marker in [
...
print("HK_1_17_80_FINAL_STATIC_GATE="+("PASS" if not failed else "FAIL"))
