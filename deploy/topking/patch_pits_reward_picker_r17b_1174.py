...
MARK="const HK_PITS_REWARD_PICKER_REV = 'pits-reward-picker-20260920-r17';"
if MARK not in s: raise SystemExit('r17a marker missing')
...
for x in ["data-pit-reward-open","pitCanonOpenRewardPicker(button.dataset.pitRewardOpen)"]:
    if x not in s: raise SystemExit('missing r17b invariant: '+x)
p.write_text(s,encoding='utf-8')
print('PITS_REWARD_PICKER_R17B_OK')
