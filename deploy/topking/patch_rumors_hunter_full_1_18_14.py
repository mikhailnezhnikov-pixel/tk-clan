...
if "rumors-hunter-coordinator-kokkaras-v40-20260926-r4" in s:
    print("RUMORS_HUNTER_FULL_1_18_14_ALREADY_PRESENT")
    raise SystemExit(0)
...
rep("const BUILD_VERSION = '1.18.13';", "const BUILD_VERSION = '1.18.14';", "build version")
...
print("RUMORS_HUNTER_FULL_1_18_14=PASS")
print("version=1.18.14")
