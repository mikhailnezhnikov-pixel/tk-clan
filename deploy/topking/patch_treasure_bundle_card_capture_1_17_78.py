...
s=s.replace("// @version      1.17.77","// @version      1.17.78",1)
s=s.replace("const BUILD_VERSION = '1.17.77';","const BUILD_VERSION = '1.17.78';",1)
...
print("TREASURE_BUNDLE_CARD_CAPTURE_1_17_78=PASS")
