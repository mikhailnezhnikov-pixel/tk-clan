...
def apply_public_war_alliance_v4_file_patch():
    _run_optional_patch("patch_public_war_alliance_v4_userscript.py", "HK_PUBLIC_WAR_ALLIANCE_V4")
...
if MARKER in s:
    ...
    apply_public_war_alliance_v4_file_patch()
