...
check("version_metadata", "// @version      1.17.82" in s)
check("version_build", "const BUILD_VERSION = '1.17.82';" in s)
...
print("HK_1_17_82_FINAL_STATIC_GATE="+("PASS" if not failed else "FAIL"))
