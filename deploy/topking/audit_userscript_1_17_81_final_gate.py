...
check("version_metadata", "// @version      1.17.81" in s)
check("version_build", "const BUILD_VERSION = '1.17.81';" in s)
...
check("treasure_bundle_dom_capture", "function treasureGuideBundleCards()" in s and "payload_json:bundleJson" in s)
check("treasure_capture_no_game_requests", "treasureGuideSubmit" in s and "/treasure-guide/capture" in s)

failed=[x for x in checks if not x[1]]
print("HK_1_17_81_FINAL_STATIC_GATE="+("PASS" if not failed else "FAIL"))
