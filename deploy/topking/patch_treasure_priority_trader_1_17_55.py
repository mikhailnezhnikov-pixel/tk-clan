...
s=s.replace("const BUILD_VERSION = '1.17.54';","const BUILD_VERSION = '1.17.55';",1)

release="// @release-note Карта Сокровищ: полные лоты Тайного торговца теперь приоритетно сохраняются из уже загруженного /shop/view без дополнительных запросов к игре.\n"
...
print("TREASURE_TRADER_PRIORITY_1_17_55=PASS")
