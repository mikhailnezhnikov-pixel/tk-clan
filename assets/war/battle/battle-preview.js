...
(async function(){
  ...
  let fixture={war_id:'preview-1',opponent:'Raider preview',opponent_type:'clan',opponent_hp:900000,opponent_hp_max:900000,our_hp:900000,our_hp_max:900000};
  let contacts=0;
  ...
  const update=()=>{renderBattleScene(fixture,themeFor(fixture.opponent));document.getElementById('war-name').textContent=fixture.opponent;window.TopKingBattleV4.update({...fixture},{},{onHp:(hp,max,meta)=>{if(meta?.animated)contacts++;status.textContent=`Preview only · HP ${hp}/${max} · contacts ${contacts} · ${window.TopKingBattleV4.version}`}})};
