(()=>{
  const labels={
    ru:{home:'Главная',information:'Гайд по игре',treasure:'Карта сокровищ',announcements:'Новости игры',recipes:'Рецепты',calculators:'Калькуляторы',maps:'Карты','mini-game':'Мини-игра',wars:'Клановые войны',ratings:'Рейтинг',feedback:'Обратная связь',cabinet:'Личный кабинет',game:'Игра',clan:'Клан',contact:'Связь'},
    en:{home:'Home',information:'Game guide',treasure:'Treasure Map',announcements:'Game news',recipes:'Recipes',calculators:'Calculators',maps:'Maps','mini-game':'Mini-game',wars:'Clan wars',ratings:'Rankings',feedback:'Feedback',cabinet:'Member area',game:'Game',clan:'Clan',contact:'Contact'},
  ...
  function ensureBranding(){
    const crest=href('assets/brand/topking-clan-crest-canon.jpg');
  ...
  function createHeader(){
    ...
    header.innerHTML=`<div class="shell topbar-inner"><a class="brand" href="${href('')}" aria-label="Top King"><img class="tk-clan-crest" src="${href('assets/brand/topking-clan-crest-canon.jpg')}" alt="Top King"></a><nav class="nav" aria-label="Navigation"></nav><div class="languages"><button data-language="ru">RU</button><button data-language="en">EN</button><button data-language="fa">FA</button></div><button class="menu-toggle" type="button" data-menu-toggle aria-expanded="false" aria-label="Menu">☰</button></div><nav class="mobile-nav" data-mobile-nav></nav>`;
