(()=>{
  const CORE={
    ru:{home:'Главная',calculators:'Калькуляторы',recipes:'Рецепты',wars:'Клановые войны',ratings:'Рейтинг',information:'Гайд по игре',announcements:'Новости игры',newsCard:'Официальные новости Hamster King, обновления, события и патчноуты.',newsDesc:'Официальные обновления и события',newsBadge:'Новости',feedback:'Обратная связь',cabinet:'Личный кабинет',menu:'Меню',footer:'Top King · Hamster King',play:'Начать играть',loading:'Загрузка…',updated:'Обновлено',noData:'Данных пока нет',error:'Не удалось загрузить данные.'},
    en:{home:'Home',calculators:'Calculators',recipes:'Recipes',wars:'Clan wars',ratings:'Rankings',information:'Game guide',announcements:'Game news',newsCard:'Official Hamster King news, updates, events and patch notes.',newsDesc:'Official updates and events',newsBadge:'News',feedback:'Feedback',cabinet:'Member area',menu:'Menu',footer:'Top King · Hamster King',play:'Play now',loading:'Loading…',updated:'Updated',noData:'No data yet',error:'Could not load data.'},
    fa:{home:'خانه',calculators:'محاسبه‌گرها',recipes:'دستورها',wars:'جنگ‌های قبیله‌ای',ratings:'رتبه‌بندی',information:'راهنمای بازی',announcements:'اخبار بازی',newsCard:'اخبار رسمی Hamster King، به‌روزرسانی‌ها، رویدادها و یادداشت‌های نسخه.',newsDesc:'به‌روزرسانی‌ها و رویدادهای رسمی',newsBadge:'اخبار',feedback:'بازخورد',cabinet:'پنل اعضا',menu:'منو',footer:'Top King · Hamster King',play:'شروع بازی',loading:'در حال بارگذاری…',updated:'به‌روزرسانی',noData:'هنوز داده‌ای وجود ندارد',error:'بارگذاری داده‌ها ممکن نشد.'}
  };
