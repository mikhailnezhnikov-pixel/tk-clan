(()=>{
  ...
  const EN={
    ...
    'Статистика участников и актуальная прокачка клана — в одном месте.':'Member statistics and current clan progression — all in one place.',
    ...
    'Официальные публикации из Telegram-канала Hamster King. Новые сообщения отображаются сверху.':'Official posts from the Hamster King Telegram channel. New posts appear first.',
    'Открыть канал':'Open channel',
    'Telegram временно недоступен — показана последняя сохранённая версия ленты.':'Telegram is temporarily unavailable — showing the latest cached feed.',
    'Читать полностью':'Read full post',
    'Публикации пока не загрузились.':'Posts have not loaded yet.',
    'Загружаю новости игры…':'Loading game news…',
    'Не удалось загрузить новости из Telegram.':'Could not load news from Telegram.',
    'Лента временно недоступна. Попробуйте открыть вкладку позже.':'The feed is temporarily unavailable. Try opening the tab again later.',
    ...
    'До воскресенья 21:00 МСК укажите, сколько Бизнесов S+ вы хотели бы купить. Заявку можно изменить до дедлайна.':'Until Sunday 21:00 Moscow time, enter how many S+ businesses you would like to buy. You can change the request until the deadline.',
    ...
    'Куплено:':'Purchased:',
    'История строится по фактическим покупкам общих лотов Clan Shop из игры. План и заявки в статистику не входят.':'Purchase history is based on actual in-game purchases of shared Clan Shop lots. Plans and requests are not included.',
    'Период истории покупок':'Purchase history period',
    'Неделя':'Week',
    'Месяц':'Month',
    '6 месяцев':'6 months',
    'Всё время':'All time',
    ...
    'Фактических покупок за этот период пока нет.':'There are no actual purchases for this period yet.',
    'Нажмите на игрока, чтобы раскрыть покупки по неделям.':'Click a player to expand purchases by week.',
    'Не удалось загрузить историю покупок.':'Could not load purchase history.',
  ...
  const FA={
    ...
    'Статистика участников и актуальная прокачка клана — в одном месте.':'آمار اعضا و پیشرفت فعلی قبیله — همه در یک‌جا.',
    ...
    'Карты':'نقشه‌ها',
    'Новости игры':'اخبار بازی',
    'Официальные публикации из Telegram-канала Hamster King. Новые сообщения отображаются сверху.':'پست‌های رسمی کانال تلگرام Hamster King. پست‌های جدید در بالا نمایش داده می‌شوند.',
    'Открыть канал':'باز کردن کانال',
    'Telegram временно недоступен — показана последняя сохранённая версия ленты.':'تلگرام موقتاً در دسترس نیست؛ آخرین نسخه ذخیره‌شده نمایش داده می‌شود.',
    'Читать полностью':'مشاهده کامل',
    'Публикации пока не загрузились.':'پست‌ها هنوز بارگذاری نشده‌اند.',
    'Загружаю новости игры…':'در حال بارگذاری اخبار بازی…',
    'Не удалось загрузить новости из Telegram.':'بارگذاری اخبار از تلگرام ممکن نشد.',
    'Лента временно недоступна. Попробуйте открыть вкладку позже.':'فید موقتاً در دسترس نیست. بعداً دوباره این تب را باز کنید.',
    ...
    'До воскресенья 21:00 МСК укажите, сколько Бизнесов S+ вы хотели бы купить. Заявку можно изменить до дедлайна.':'تا یکشنبه ساعت ۲۱:۰۰ به وقت مسکو تعداد کسب‌وکارهای S+ موردنظر را وارد کنید. درخواست تا مهلت قابل تغییر است.',
    ...
    'История покупок':'تاریخچه خریدها',
    'Куплено:':'خریداری‌شده:',
    'История строится по фактическим покупкам общих лотов Clan Shop из игры. План и заявки в статистику не входят.':'تاریخچه بر اساس خریدهای واقعی لوت‌های مشترک فروشگاه کلن در بازی محاسبه می‌شود. برنامه و درخواست‌ها در آمار حساب نمی‌شوند.',
    'Период истории покупок':'بازه تاریخچه خرید',
    'Неделя':'هفته',
    'Месяц':'ماه',
    '6 месяцев':'۶ ماه',
    'Всё время':'کل زمان',
    'Игроков':'بازیکنان',
    'Игрок':'بازیکن',
    'Всего покупок':'کل خریدها',
    'Опубликованных покупок за этот период пока нет.':'هنوز خرید منتشرشده‌ای برای این بازه وجود ندارد.',
    'Нажмите на игрока, чтобы раскрыть покупки по неделям.':'برای دیدن خریدها بر اساس هفته روی بازیکن بزنید.',
    'Не удалось загрузить историю покупок.':'بارگذاری تاریخچه خریدها ممکن نشد.',
