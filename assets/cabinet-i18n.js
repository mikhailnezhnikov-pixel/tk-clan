(()=>{
  ...
  const EN={
    ...
    'Считаются только опубликованные итоговые списки. Заявки игроков в статистику не входят.':'Only published final lists are counted. Player requests are not included in the statistics.',
    ...
    'Опубликованных покупок за этот период пока нет.':'There are no published purchases for this period yet.',
  ...
  const FA={
    ...
    'Считаются только опубликованные итоговые списки. Заявки игроков в статистику не входят.':'فقط فهرست‌های نهایی منتشرشده محاسبه می‌شوند. درخواست‌های بازیکنان در آمار حساب نمی‌شوند.',
