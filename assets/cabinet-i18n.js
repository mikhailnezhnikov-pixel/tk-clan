(()=>{
  ...
  const EN={
    ...
    'До воскресенья 21:00 МСК укажите, сколько вы хотели бы купить. Это заявка на покупку; её можно изменить до дедлайна.':'Until Sunday 21:00 Moscow time, enter how many items you would like to buy. This is a purchase request and can be changed until the deadline.',
  ...
  const FA={
    ...
    'До воскресенья 21:00 МСК укажите, сколько вы хотели бы купить. Это заявка на покупку; её можно изменить до дедлайна.':'تا یکشنبه ساعت ۲۱:۰۰ به وقت مسکو تعداد موردنظر خود را وارد کنید. این یک درخواست خرید است و تا مهلت قابل تغییر است.',
